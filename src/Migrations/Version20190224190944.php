...
final class Version20190224190944 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE product (id VARCHAR(255) NOT NULL, tax_rate_id VARCHAR(255) NOT NULL, type_id VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, price DOUBLE PRECISION NOT NULL, currency VARCHAR(3) NOT NULL, INDEX IDX_D34A04ADFDD13F95 (tax_rate_id), INDEX IDX_D34A04ADC54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
